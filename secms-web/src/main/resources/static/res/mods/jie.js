...
layui.define('fly', function(exports){
  ...
  fly.form['/jie/reply/'] = function(data, required){
    var tpl = '<li>\
      <div class="detail-about detail-about-reply">\
        <a class="fly-avatar" href="/u/{{ layui.cache.users.uid }}" target="_blank">\
          <img src="{{= d.users.avatar}}" alt="{{= d.users.username}}">\
        </a>\
        <div class="fly-detail-users">\
          <a href="/u/{{ layui.cache.users.uid }}" target="_blank" class="fly-link">\
            <cite>{{d.users.username}}</cite>\
          </a>\
        </div>\
  ...
  gather.jiedaActive = {
    ...
    ,reply: function(li){ //回复
      ...
      var aite = '@'+ li.find('.fly-detail-users cite').text().replace(/\s/g, '');
      dom.content.focus()
